    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center bg-black">
        <div id="top" className="w-full pt-[20%] lg:pt-[10%]">
          {mobileQuery === 'desktop' ? (
            <div className="relative h-auto w-full">
              <img src={cybertruckImgDesktop} alt="WindMar Solar + Roofing's Tesla CyberTruck promotion" className="h-auto w-full" />
        ...
        <article className="flex w-full flex-col items-center p-3">
          <div className="flex w-full flex-col items-center justify-center">
            <div className="relative bottom-[28%] flex h-full w-full flex-col items-center justify-center lg:bottom-[91%] lg:mb-[8%] lg:h-full lg:w-[80%]">
              <div className="flex w-full flex-col items-center">
                <h1 className="w-[95%] text-center text-[20px] font-bold uppercase text-white lg:w-[95%] lg:text-[27px]">
                  Fill out this survey for the chance to win a Cybertruck!
                </h1>
                <p className="text-center text-[16px] uppercase text-gray-300 lg:mb-[2%] lg:text-[20px]">Start Your Transition to Solar Energy!</p>
              </div>
              <FormsLeadsFL_DN_JSD
                id="FormCyberTruckFL"
            ...
            <p className="relative bottom-[22%] w-full text-center text-2xl uppercase text-white lg:bottom-[100%] lg:w-[80%] lg:text-[25px]">
              SWITCH TO SOLAR WITH WINDMAR SOLAR + ROOFING AND ENTER TO WIN A <strong>CYBERTRUCK OR A TESLA</strong> POWERWALL
            </p>
        ...
        <div className="relative bottom-[2%] w-full text-white lg:bottom-[12%] lg:w-[65%]">
          <section>
            <h2 className="text-center font-bold text-white lg:mb-[5%]">TO PARTICIPATE</h2>
            ...
            <Link to="/fl/cybertruckRules" className="mb-[5%] flex flex-col items-center justify-center no-underline">
              <button className="w-[90%] cursor-pointer border-[2px] px-[3%] py-[1%] font-bold text-white">GIVEAWAY RULES</button>
            </Link>
          </section>
        </div>
        ...
        <section className="relative bottom-[1%] lg:bottom-[5%]">
          {mobileQuery === 'desktop' ? (
            <>
              ...
              <h3 className="mb-[5%] mt-[5%] text-center text-white">POWER UP AND WIN WITH WINDMAR SOLAR + ROOFING</h3>

              <Link to="/fl/cybertruckRules" className="flex flex-col items-center justify-center no-underline">
                <button className="mb-[5%] w-[90%] cursor-pointer border-[2px] px-[3%] py-[1%] font-bold text-white">GIVEAWAY RULES</button>
              </Link>
            </>
          ) : (
            <>
              <h1 className="mt-[5%] text-center text-[18px] font-[700] text-white">GIVEAWAY RULES</h1>
              <h3 className="mb-[5%] mt-[5%] text-center text-[18px] font-[700] text-white">POWER UP AND WIN WITH WINDMAR SOLAR + ROOFING</h3>
...
export default CybertruckFL_JSD
