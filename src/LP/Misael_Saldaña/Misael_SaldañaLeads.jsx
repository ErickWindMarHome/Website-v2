...
function Misael_SaldañaLeads() {
  useTitle('Team Misael Saldaña - Windmar')
  return (
    <>
      <div className="flex w-full flex-col items-center justify-center">
        <div className="flex h-auto w-full flex-col items-center justify-start bg-[url('https://windmar-website-cms.s3.us-east-1.amazonaws.com/LPs/JorgeSerrano/Fondo+Panel+solar-02.webp')] bg-cover bg-no-repeat">
          <img
            ...
            alt=""
          />
          <section className="flex w-[80%] flex-col items-center justify-center md:w-[50%] md:flex-row md:p-10">
            <div className="w-full md:w-[90%]">
              <h1 className="my-4 w-full text-center text-[20px] text-white md:text-[25px]">
                Únete a <strong>WindMar Home</strong> en tu transición a <strong>energía solar</strong> y <strong>protege</strong> tu hogar con
                nuestros servicios de <strong>roofing</strong>, mientras te olvidas de la inestabilidad de la{' '}
                <strong>red eléctrica tradicional</strong>.
              </h1>
              <FormsLeads_PR_RHF
                id="Team-Misael-Saldana-Leads"
                campaign={'MisalesSaldana'}
...
export default Misael_SaldañaLeads
