...
export default function ModalEnvioDeal({ error, setModal, DealId }) {
  return (
            ...
            {DealId && (
              <>
                <p className="text-blue-500 underline">
                  <a href={`${zohoBaseUrl}/Leads/${DealId}`} target="_blank" rel="noopener noreferrer">
                    Haga clic aquí para ver el registro en Zoho.
                  </a>
                </p>
                <p className="text-white">Verifique que el campo Lead Name sea igual al de Deal Name</p>
              </>
            )}
          </div>
        </div>
